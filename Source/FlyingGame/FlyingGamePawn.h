...
#include "FlyingGamePawn.generated.h"

UCLASS(config=Game)
class AFlyingGamePawn : public APawn
{
	GENERATED_BODY()
	...
	/** Failsafe Component */
	UPROPERTY(Category = Failsafe, VisibleDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	class UFailsafeComponent* FailsafeComponent;
public:
	AFlyingGamePawn();
